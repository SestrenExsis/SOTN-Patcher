...
if __name__ == '__main__':
    ...
    parser.add_argument('offset', help='Input an optional hex address offset', type=str, default="0x00")
    args = parser.parse_args()
    address = Address(int(args.address, 16) + int(args.offset, 16), args.type)
