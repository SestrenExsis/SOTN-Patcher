...
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/clock-hands-mod.json" --ppf="build/ppf/clock-hands-mod.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/customized-castle-map-reveals.json" --ppf="build/ppf/customized-castle-map-reveals.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/customized-color-palettes.json" --ppf="build/ppf/customized-color-palettes.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/customized-enemy-drops.json" --ppf="build/ppf/customized-enemy-drops.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/disable-clipping-on-one-way-walls.json" --ppf="build/ppf/disable-clipping-on-one-way-walls.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/enable-debug-mode.json" --ppf="build/ppf/enable-debug-mode.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/fix-secret-room-map-pixels.json" --ppf="build/ppf/fix-secret-room-map-pixels.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/improve-normalized-room-visuals.json" --ppf="build/ppf/improve-normalized-room-visuals.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/mix-items-and-relics.json" --ppf="build/ppf/mix-items-and-relics.ppf" || goto :error
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/move-drawbridge-room-vertically.json" --ppf="build/ppf/move-drawbridge-room-vertically.ppf" || goto :error
...
python src/sotn_ppf.py %EXTRACT% --data="data/" --changes="tests/normalize-jewel-sword-passageway.json" --ppf="build/ppf/normalize-jewel-sword-passageway.ppf" || goto :error
